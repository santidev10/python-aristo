# usage:
# python create_release_deploy.py <Build_Name> <Build_Version>  
# python3 current-TC-script-HHR.py Monaco_HistoricalHorseRacing_262_FullBuild_Gdk30 2.6.3.7    
# python create_release_deploy.py Monaco_WinnersWorldR25_270_FullBuild_Gdk35 2.7.0.10
# python create_release_deploy.py Monaco_HistoricalHorseRacing_261_FullBuild_Gdk20 2.6.1.516
# python create_release_deploy.py Monaco_HistoricalHorseRacing_261_FullBuild_Gdk30 2.6.1.16
...
def up_var(a, b):
    ...
    # octopus_server_uri = 'http://deploy-monaco.ali.local/api'
...
#########   RELEASE #############
# octopus_server_uri = 'http://deploy-monaco.ali.local'
octopus_server_uri = 'http://10.196.80.68'
octopus_api_key = 'API-TJMD4RUEIXAS8PJ6WBBQREUFIX3YMM'
headers = {'X-Octopus-ApiKey': octopus_api_key}
space_name = "Spaces-1"
project_name = "Projects-27"
# environment_name = 'Development'
# channel_name = 'Default'
release_version = name  + '_' + version  # this needs to be unique
environment_name = 'Environments-43'
...
# ############ DEPLOY Commented out because deployment is automatically triggered by system #########
